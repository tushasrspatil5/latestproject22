...
urlpatterns = [
    # for store owner
    path('ajax/foo/<int:myid>', views.upload, name='upload'),
    ...
    path('users-notifications',views.UsersNotifications,name='users-notifications'),
    ...
    path('medical_store_view/<int:myid>',views.medical_store_view, name = 'medical_store_view'),
    path('store-view/<int:myid>/<str:st_name>/<str:st_dist>',views.medical_store_view, name='medical_store_view'),
    
    path('medical-store-view/<int:myid>/upload-prescriptions',views.upload, name = 'medical_store_view'),
    ...
    path('order-tracker/<int:myid>',views.OrderTracker,name='order-tracker'),
    ...
    path('app-view/home/select-location',views.Select_Location_Store,name='Select_Location_Store'),
    path('app-view/store-view/<int:myid>/<str:st_name>/<str:st_dist>',views.medical_store_view, name='medical_store_view'),
    path('app-view/medical-store-view/<int:myid>/upload-prescriptions',views.upload, name = 'medical_store_view'),
    path('app-view/checkout',views.CheckOut,name='checkout'),
    path('app-view/users-notifications',views.UsersNotifications,name='app-view/notifications'),
